    ...
    <div className="hotline-page-container">
      ...
      <div className="hotline-page-header">
        <div className="hotline-page-header-content">
          <div className="hotline-page-logo">OPAL</div>
          ...
          <div className="hotline-page-list">
            ...
            <div className="hotline-page-section">
              ...
              <div className="hotline-page-entries">
                ...
                <p className="hotline-page-entry">Region II: (078) 844-1630</p>
                <p className="hotline-page-entry">Region III: (045) 455-1145</p>
                <p className="hotline-page-entry">
            ...
            <div className="hotline-page-section">
              ...
              <div className="hotline-page-entries">
                ...
                <p className="hotline-page-entry">Region IX: (062) 215-3984</p>
                <p className="hotline-page-entry">
            ...
            <div className="hotline-page-section">
              <h2 className="hotline-page-subcategory">Manila Water Hotline</h2>
